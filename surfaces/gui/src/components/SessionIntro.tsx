      ...
      <div className="intro-tasks">
        <button className="task-card" data-testid="intro-task-folder" onClick={pickFolder}>
          <span className="task-card-body">
            <span className="task-card-title">{translate("session.intro.analyzeFilesDirectory")}</span>
            <span className="task-card-sub">{translate("session.intro.iLlReadThemSummarizeWhatMatters")}</span>
          </span>
          <span className="task-card-act">{translate("session.intro.pickFolder")}</span>
        </button>
        {addingFolder && (
        ...
        >
          <span className="task-card-body">
            <span className="task-card-title">{translate("session.intro.createReportMyHubspotLeads")}</span>
        ...
        >
          <span className="task-card-body">
            <span className="task-card-title">{translate("session.intro.weeklyGithubReport")}</span>
            <span className="task-card-sub">
