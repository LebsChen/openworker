      ...
      <div className="w-[600px] max-w-[92vw] h-[560px] max-h-[88vh] rounded-2xl border border-line bg-panel shadow-2xl p-8 flex flex-col">
        ...
        {step === 0 && (
          <section data-testid="ob-step-model" className="flex-1 min-h-0 flex flex-col">
            ...
            <h1 className="text-[19px] font-semibold">{translate("onboarding.welcomeOpenworker")}<span className="beta-tag">{translate("onboarding.beta")}</span></h1>
        ...
        {step === 1 && (
          ...
          <section data-testid="ob-step-tools" className="flex-1 min-h-0 flex flex-col">
            <h1 className="text-[19px] font-semibold">{translate("onboarding.connectEverydayTools")}</h1>
            ...
            <div className="flex-1 min-h-0 overflow-y-auto pr-1" data-testid="ob-tool-gallery">
              {TOOL_ROWS.map(({ name, benefit, detail }) => {
                ...
                return (
                  ...
                  >
                    ...
                    {cloud?.signed_in &&
                      (c.connected ? (
                        <span className="text-[12px] text-ok font-medium shrink-0">{translate("onboarding.connected")}</span>
                      ) : pendingTool === name ? (
                        <span className="text-[12px] text-muted shrink-0">{translate("onboarding.checkBrowser")}</span>
                      ) : (
                        <button
              ...
              <div className="flex items-center gap-3 py-2" data-testid="ob-tool-google-soon">
                ...
                {cloud?.signed_in && <span className="text-[11.5px] text-faint shrink-0">{translate("onboarding.comingSoon")}</span>}
              </div>
            </div>
        ...
        {step === 2 && (
          <section data-testid="ob-step-done" className="flex-1 min-h-0 flex flex-col overflow-y-auto">
            <div className="text-center">
              ...
              <h1 className="text-[19px] font-semibold mb-1">{translate("onboarding.youReSetUp")}</h1>
              <p className="text-[13px] text-muted mb-5">{translate("onboarding.twoGoodWaysStart")}</p>
            </div>
            ...
            >
              ...
              <span className="flex-1 min-w-0 text-left">
                <b className="block text-[13.5px]">{translate("onboarding.createFirstAutomation")}</b>
            ...
            >
              ...
              <span className="flex-1 min-w-0 text-left">
                <b className="block text-[13.5px]">{translate("onboarding.startWorkingCoworker")}</b>
                <span className="text-[12px] text-muted">
